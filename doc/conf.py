...
project = 'juise'
copyright = '2024, Juniper Networks'
author = 'Phil Shafer'
default_role = 'code'
primary_domain = 'c'
smart_quotes = False
...
latex_documents = [
    (master_doc, 'juise.tex', 'juise Documentation',
     'Phil Shafer', 'manual'),
]
...
man_pages = [
    (master_doc, 'juise', 'juise Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'juise', 'juise Documentation',
     author, 'juise', 'A Library for running JUNOS scripts',
     'Miscellaneous'),
]
